...
const Category = (props: Props) => {
	...
	useEffect(() => {
		const getCateByPro = async () => {
			const { data: { products } } = await axios.get("http://localhost:8000/api/category/" + id)
			setProduct(products)
		}
		getCateByPro()
	}, [])
													...
													<div id="collapseTwo" className="collapse show" data-parent="#accordionExample">
														<div className="card-body">
															<div className="shop__sidebar__brand">
																	...
																	<ul>
																		<li><Link to={`/shop/category/${category._id}`}>{category.name}</Link></li>
																	</ul>
																	))}
															</div>
														</div>
										...
										<div className="product__item">
											<div className="product__item__pic setbg"  style={{backgroundImage: `url(${products.image})`}}>
													<ul className="product__hover">
														...
														<li><a href="#"><img src="/src/lib/img/icon/compare.png" alt=""/> <span>Compare</span></a>
														</li>
